...
- HANA_LoadHistory_Hosts_2.00.060+
...
- 2022/11/10:  1.9 (redesigned memory columns)
  ...
  ( SELECT
    ...
    ( SELECT
      ...
      ( SELECT                      /* Modification section */
          ...
          '%' HOST,
          'CURRENT' DATA_SOURCE,
          'NONE' AGGREGATE_BY,               /* TIME, SITE_ID, HOST and comma separated combinations, NONE for no aggregation */
