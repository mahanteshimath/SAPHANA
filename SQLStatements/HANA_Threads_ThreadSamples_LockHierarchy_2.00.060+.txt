...
HANA_Threads_ThreadSamples_LockHierarchy_2.00.060+
...
- 2022/10/03:  1.4 (redesign using SQL hierarchies)
- 2022/10/04:  1.4 (STATEMENT_HASH filter included)
...
- MAX_HIERARCHY_LEVEL
  ...
  Possibility to display only the top levels of the hierarchy

  1               --> Only display the final blocking sessions
  2               --> Display final blocking session and the first level of waiters
  -1              --> No restriction related to hierarchy level
