...
- HANA_liveCache_Procedures_2.00.060+
  ...
  ( SELECT
    ...
    ( SELECT
      ...
      ( SELECT                /* Modification section */
          ...
          'NONE' AGGREGATE_BY,           /* TIME, SITE_ID, HOST, PORT, OBJECT, METHOD or comma separated combinations, NONE for no aggregation */
