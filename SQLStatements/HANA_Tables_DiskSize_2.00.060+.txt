...
- 2022/05/26:  1.6 (dedicated 2.00.060+ version including SITE_ID for data source HISTORY, SERVICE_NAME removed)
    ...
    ( SELECT
      ...
      ( SELECT
        ...
        ( SELECT                /* Modification section */
            ...
            -1 MIN_SIZE_GB,
            'CURRENT' DATA_SOURCE,
            'HOST' AGGREGATE_BY,       /* TIME, SITE_ID, HOST, PORT, SCHEMA, TABLE, VFILE, STORE and comma separated combinations, NONE for no aggregation */
