    ...
    ( SELECT
      ...
      ( SELECT
        ...
        ( SELECT                      /* Modification section */
            ...
            'X' EXCLUDE_STANDBY,
            'CURRENT' DATA_SOURCE,
            'TIME, HOST' AGGREGATE_BY,               /* TIME, SITE_ID, HOST, PORT and comma separated combinations, NONE for no aggregation */
      ...
      WHERE
        ( BI.EXCLUDE_STANDBY = ' ' OR BI.DATA_SOURCE = 'HISTORY' OR S.COORDINATOR_TYPE IS NULL OR S.COORDINATOR_TYPE != 'STANDBY' )
      GROUP BY
        CASE 
          WHEN BI.AGGREGATE_BY = 'NONE' OR INSTR(BI.AGGREGATE_BY, 'TIME') != 0 THEN 
            CASE 
