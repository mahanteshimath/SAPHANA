...
- HANA_liveCache_OMSVersions_1.00.90+
...
( SELECT
  ...
  ( SELECT
    ...
    ( SELECT              /* Modification section */
        ...
        'NONE' AGGREGATE_BY,           /* TIME, HOST, PORT, VERSION_ID, DESCRIPTION, IS_OPEN or comma separated combinations, NONE for no aggregation */
