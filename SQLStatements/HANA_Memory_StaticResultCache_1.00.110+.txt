...
- HANA_Memory_StaticResultCache_1.00.110+

[DESCRIPTION]

- SAP HANA static result cache information
...
- Static result cache available as of SAP HANA 1.00 Rev. 110 (SAP Note 2336344)
...
- 2016/06/28:  1.0 (initial version)
...
*/
  ...
  LPAD(R.ACCESS_COUNT, 8) ACCESSES,
  LPAD(R.RUNTIME_MISS_COUNT, 6) MISSES,
  LPAD(R.EVICT_COUNT, 9) EVICTIONS
FROM
