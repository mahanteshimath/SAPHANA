...
- HANA_StatisticsServer_Alerts_History
...
- 2017/09/12:  1.2 (STATISTICS_ALERTS replaced with STATISTICS_ALERTS_BASE due to UTC timestamp issue)
...
- 2022/05/27:  1.6 (HOST and PORT included, useful to identify system replication site of alert)
...
*/
  ...
  LPAD(DISTINCT_ALERTS, 15) DISTINCT_ALERTS
FROM
( SELECT 
    CASE 
  ...
  ( SELECT
    ...
    ( SELECT                  /* Modification section */
        ...
        'TIME, ALERT, DETAIL, LEVEL' AGGREGATE_BY,     /* TIME, HOST, PORT, ALERT, DETAIL, LEVEL or comma separated combinations, NONE for no aggregation */
