...
- HANA_IO_KeyFigures_Total_2.00.060+
      ...
      ( SELECT
        ...
        ( SELECT
          ...
          ( SELECT                                 /* Modification section */
              ...
              'TIME, TYPE' AGGREGATE_BY, /* TIME, SITE_ID, HOST, PORT, TYPE, PATH, FILESYSTEM and comma separated combinations or NONE for no aggregation */
