...
- HANA_liveCache_Containers_2.00.060+
...
- 2022/05/26:  1.5 (dedicated 2.00.060+ version including SITE_ID for data source HISTORY)
...
( SELECT
  ...
  ( SELECT
      C.SERVER_TIMESTAMP,
      CASE WHEN BI.AGGREGATE_BY = 'NONE' OR INSTR(BI.AGGREGATE_BY, 'SITE_ID')   != 0 THEN TO_VARCHAR(C.SITE_ID)      ELSE MAP(BI.SITE_ID,      -1, 'any', TO_VARCHAR(BI.SITE_ID))      END SITE_ID,
    ...
    ( SELECT
      ...
      ( SELECT                         /* Modification section */
          ...
          'SCHEMA' AGGREGATE_BY,           /* TIME, SITE_ID, HOST, PORT, CLASS, CONTAINER, SCHEMA or comma separated combinations, NONE for no aggregation */
    ...
    GROUP BY
      C.SERVER_TIMESTAMP,
      CASE WHEN BI.AGGREGATE_BY = 'NONE' OR INSTR(BI.AGGREGATE_BY, 'SITE_ID')   != 0 THEN TO_VARCHAR(C.SITE_ID)      ELSE MAP(BI.SITE_ID,      -1, 'any', TO_VARCHAR(BI.SITE_ID))      END,
